namespace Az.Storage.Cache
{
    ...
    {
        private static Dictionary<Type, ICache<Dictionary<string, string>>> _string = new Dictionary<Type, ICache<Dictionary<string, string>>>();
        public static Dictionary<Type, ICache<Dictionary<string, string>>> CacheStore { get => _string; }
        ...
        public static ICache<Dictionary<string, string>> Get<T>() => CacheStore[typeof(T)];
